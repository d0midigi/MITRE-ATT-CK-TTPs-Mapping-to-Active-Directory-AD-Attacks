...
- AdminSDHolder (T1098): Modifying the permissions of the AdminSDHolder container. AD automatically propagates these permissions to l protected groups (like Domain Admins) every 60 minutes.
...
TTPs: LLMNR/NBT-NS Poisoning (T1557.001) or Spearphishing (T1566.001)
#### Primary Tools:
...
2. Reconnaissance
TTP: Domain Trust / Object Discovery (T1482)
Primary Tools:
...
TTPs: Kerberoasting (T1558.003) or AD CS ESC1 (T1649)
Primary Tools:
...
4. Lateral Movement
TTP: Overpass-the-Hash / Pass-the-Ticket (PtT)
Primary Tools:
...
5. Persistence
TTPs: Golden Ticket (T1558.001) or GPO Modification (T1484.001)
Primary Tools:
...
Coerced Authentication & NTLM Relaying
TTPs: Adversary-in-the-Middle (AitM) (T1557.001) and Exploitation of Remote Services (T1210)
...
TTP: Account Manipulation (T1098)
...
TTP: Access Token Manipulation (T1134) and Boot or Logon Autostart Execution (T1547)
...
TTP: Steal or Forge Kerberos Tickets (T1558)
...
Expanded Red Team Mapping Table
Phase	Attack Technique	MITRE TTP	Primary Tool
Initial	Coerced Auth	T1210	PetitPotam
Escalation	Shadow Credentials	T1098	Whisker
Escalation	AD CS Relay (ESC8)	T1557.001	ntlmrelayx
...
🛡️ 1. Detection Evasion Deep-Dive (AMSI & ETW)
...
ETW Patching: Similar to AMSI, you can patch EtwEventWrite in ntdll.dll to prevent the OS from sending telemetry to the EDR.
